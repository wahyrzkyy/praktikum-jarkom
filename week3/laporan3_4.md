# Laporan praktikum jarkom week3 (3.4 HTML Documents dengan Embedded Objects )
...
5. Saat Wireshark sedang berjalan, masukkan URL: http://gaia.cs.umass.edu/wireshark-labs/HTTP-wireshark-file4.html dan tampilkan halaman tersebut di browser anda. 
6. Lalu balik lagi ke wireshark dan stop capturing packets atau pencet logo stop yang berwarna merah
7. Masukkan atau filter bagian protocol http saja di display-filter-specification window (textfield filter paket di bagian atas daftar paket), sehingga hanya pesan HTTP yang diambil yang akan ditampilkan nanti di jendela daftar paket.

## Lampiran
![Hasil Percobaan](../assets/image/mod3_4.png)